...
export default function LoginPage() {
  ...
  async function handleGoogleSignIn() {
    await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: {
        redirectTo: 'https://investquest-ten.vercel.app/auth/callback',
      },
    })
  }
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl px-8 py-10 sm:px-10">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-gold hover:opacity-90 text-navy font-semibold px-5 py-3.5 rounded-xl transition-opacity duration-150 shadow-sm"
          >
            <GoogleIcon />
